...
<body>
<h4>Hello <xsl:value-of select="order/customer/name"/>,
<br/><br/>Your order has been recieved.</h4>
Account: <xsl:value-of select="order/customer/@account"/>
<br/>Date Submitted: <xsl:value-of select="order/@submitted"/><br/><br/>
<table border="3" cellpadding="3"><tbody>
<tr>
<th>Number</th>
<th>Name</th>
<th>Unit Price</th>
